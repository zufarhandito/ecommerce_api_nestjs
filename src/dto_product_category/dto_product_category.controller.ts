...
export class DtoProductCategoryController {
  constructor(private readonly dtoProductCategoryService: DtoProductCategoryService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateDtoProductCategoryDto: UpdateDtoProductCategoryDto) {
    return this.dtoProductCategoryService.update(+id, updateDtoProductCategoryDto);
  }
